setTimeout(() => {
  ...
  var productData = [
    ...
    {
      title: "Single Malt Scotch Caramel Heart Tin",
      padgeClass: "best_seller",
      padgeTitle: "Best Seller",
      padgeIcon: `best_seller_icon`,
      productDescription:
        "The richest, smokiest caramels they’ll ever taste, packed with care in a sleek Manly Man tin heart.",
      clientReview: `”My husband & I really liked these scotch caramels. We couldn’t stop eating them”`,
      client: `- Nicole R.`,
    },
    {
    ...
    {
      title: "The Best Jerky Gift Box",
      padgeClass: "best_seller",
      padgeTitle: "Best Seller",
      padgeIcon: `best_seller_icon`,
      productDescription:
        "Perfect for jerky lovers! This assortment of gourmet jerky comes with a variety of savory and spicy flavors to sample.",
      clientReview: `“He had a big smile on his face as he just kept pulling more and more jerky out of the box.”`,
      client: `- CJG.`,
    },
    {
    ...
    {
      title: "Bacon Jerky Gift Box",
      padgeClass: "best_seller",
      padgeTitle: "Best Seller",
      padgeIcon: `best_seller_icon`,
      productDescription:
        "No need to hunt for lunch or dinner. This Bacon Jerky Gift Box already comes loaded with 6 tasty varieties of bacon jerky",
      clientReview: `“Excellent Gift! Made a great and unique gift. They loved all the flavors of the bacon jerky, although the jalepeno was definitely hot/spicy. Overall, loved it!!”`,
      client: `- Anonymous.`,
    },
    {
      title: "The Bacon Bouquet",
    ...
    {
      title: "Bacon Scented Gift Wrapping Paper",
      padgeClass: "new_seller",
      padgeTitle: "New",
      padgeIcon: ``,
      productDescription:
        "Wrap the perfect gift in the perfect gift wrapping paper! This bacon-scented wrapping paper will have him cheering before he’s done tearing in.",
      clientReview: `“Experience was great, rec’d on time and the recipient said it was the best gift he’s ever gotten.”`,
      client: `- Walt R.`,
    },
    {
      title: "Manly Man Beer Candle",
      padgeClass: "best_seller",
      padgeTitle: "Best Seller",
      padgeIcon: `best_seller_icon`,
      productDescription:
        "A 16 oz Manly Man glass filled with beer-scented gel wax and soy wax to look and smell like a real pint of beer!",
      clientReview: `“Saw it, ordered it, came quickly! A great gift for my manly boyfriend!”`,
      client: `- Anonymous Reviewer`,
    },
    {
      title: "The Bloody Mary Kit",
      padgeClass: "best_seller",
      padgeTitle: "Best Seller",
      padgeIcon: `best_seller_icon`,
      productDescription:
        "Paired with your favorite vodka, this kit includes instructions and ingredients to make the perfect deliciously meaty Bloody Mary!",
      clientReview: `“This was a great treat for my Manly man! Thank you for being creative with meat!!”`,
      client: `- Roo C.`,
    },
    {
  ...
  var bestSellerIcon = `<svg width="16" height="21" viewBox="0 0 16 21" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path
  ...
  var personalizedIcon = `<svg width="16" height="17" viewBox="0 0 16 17" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  function addChanges() {
    var buttons = $(".collection__main .product__thumbnail > div:last-of-type");
    var productThumbnails = $(".collection__main .product-thumbnail");

    productThumbnails.each(function (i, item) {
      var icon = "";
      if (!$(item).hasClass("optimize_shown")) {
        var productTitle = $(item).find(".product-thumbnail__title").text();
        var selectedProduct = productData.find(
          (prod) => prod.title === productTitle
        );
        if (selectedProduct.padgeIcon === "best_seller_icon") {
          icon = bestSellerIcon;
        } else if (selectedProduct.padgeIcon === "personalized_icon") {
          icon = personalizedIcon;
        }
        $(item).addClass("optimize_shown");
        $(item).after(`
