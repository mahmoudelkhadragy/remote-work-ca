(function () {
  ...
  <section class="cast">
    <div class="container">
      ...
      <ul class="cast__list">
        ...
        <li class="cast__list-item">
          <img
            src="https://i.imgur.com/WgXplG5.png"
            alt="Reaper"
            class="list-item__image"
          />
  ...
  <section class="hot">
    <div class="container">
      <h3 class="hot-banner__heading">
        See this sauce in action on YouTube!
      </h3>
      <div class="hot-inner">
        <iframe
          width="560"
          height="315"
          src="https://www.youtube.com/embed/MRy3M17UVL4"
    ...
    <div class="container">
      <div class="chicken-inner">
        <div class="chicken-content">
          ...
          <img
            src="https://i.ibb.co/CwqrjVk/1.png"
  ...
  <section class="reviews">
    <div class="container">
      ...
      <div class="row">
        <div class="col-12" id="review_content_here"></div>
      </div>
    </div>
  </section>
  ...
  setTimeout(() => {
    ...
    $("#review_content_here").append($("#tab_review"));
    $("#tab_review").show();
  }, 3000);
})();
