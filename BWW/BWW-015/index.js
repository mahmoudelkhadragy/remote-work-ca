...
allBuySections.each(function () {
  ...
  let url = convert.$(this).find('h4 a').attr('href');
  let url1 = convert.$(this).children('a').attr('href');
...
convert.$(convert.$(`.country-compare-table`)[0]).after(`
...
.con_table tbody tr td.con_title div {
  display: flex;
  align-items: center;
  color: #2579c6;
}
