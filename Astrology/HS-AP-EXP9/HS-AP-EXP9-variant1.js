...
$(document).ready(function () {
  ...
  $('.woocommerce-product-gallery').before(`<div class="opt_main_mobile"></div>`);

  $('.opt_main_mobile').append($('.product_title.entry-title').clone());
  $('.opt_main_mobile').append($('.woocommerce-product-details__short-description').clone());
